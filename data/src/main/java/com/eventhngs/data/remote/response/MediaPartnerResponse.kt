...
data class MediaPartnerResponse(

	@field:SerializedName("data")
	val data: MediaPartnerData? = null,
...
data class MediaPartnerData(

	@field:SerializedName("total")
	val total: Int? = null,

	@field:SerializedName("data")
	val data: List<MediaPartnerItem>? = null,
