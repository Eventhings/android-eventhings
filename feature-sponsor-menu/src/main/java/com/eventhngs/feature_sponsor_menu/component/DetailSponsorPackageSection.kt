package com.eventhngs.feature_sponsor_menu.component
...
@Composable
fun DetailSponsorPackageSection(
    modifier: Modifier = Modifier,
    packages: List<SponsorPackage> = emptyList(),
    onDecreaseClick: (SponsorPackage) -> Unit = {},
    onIncreaseClick: (SponsorPackage) -> Unit = {},
) {
...
@Preview
@Composable
fun PreviewDetailSponsorPackageSection() {
    EventhngsTheme {
        Surface {
